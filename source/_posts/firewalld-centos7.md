---
title: CentOS7使用firewalld管理防火墙与端口
date: 2016-10-22 21:24:46
tags: [CentOS7]
keywords: Centos7防火墙 CentOS7使用firewalld管理防火墙与端口
categories: Linux
---
...
开启连续多个端口：
firewall-cmd --zone=public --add-port=1000-1500/tcp --permanent
```
